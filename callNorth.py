...
#finally calling the other room's transporter.py
print"Location:http://www.cs.mcgill.ca/~nndiay4/cgi-bin/transporter.py?inventory="+playerMana+"%2C"+playerGold+"&URL=http%3A%2F%2Fwww.cs.mcgill.ca%2F%7Ewalhas1%2Fcgi-bin%2Froom.cgi%3Fcommand%3DREFRESH%26inventory%3D"+playerMana+"%252C"+playerGold+"\r\n"
